...
public class MenuPopulator implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Breakfast housemadeGranola = new Breakfast("Housemade Granola",
				...
				"9", breakfast, "/images/Breakfast/housemade-granola.jpeg", "/images/Breakfast/housemade-granola-2.jpg", "/images/Breakfast/housemade-granola-3.jpg");
		...
		Lunch simpleSalad = new Lunch("Simple Salad", "Crisp greens and rosemary croutons with cafe vinaigrette.", "5",
				lunch, "/images/Lunch/simple-salad.jpeg", "/images/Lunch/simple-salad-2.jpg", "/images/Lunch/simple-salad-3.jpg");
		Lunch choppedSalad = new Lunch("Chopped Salad",
				...
				"15", lunch, "/images/Lunch/chopped-salad.jpeg", "/images/Lunch/chopped-salad-2.jpg", "/images/Lunch/chopped-salad-3.jpg");
		Lunch beechwoldSalad = new Lunch("Beechwold Salad",
				...
				"14", lunch, "/images/Lunch/beechwold-salad.jpeg", "/images/Lunch/beechwold-salad-2.jpg", "/images/Lunch/beechwold-salad-3.jpg");
		Lunch citrusCrunchSalad = new Lunch("Citrus Crunch Salad",
				...
				"14.5", lunch, "/images/Lunch/citrus-crunch-salad.jpg", "/images/Lunch/citrus-crunch-salad-2.jpg", "/images/Lunch/citrus-crunch-salad-3.jpg");
		Lunch buddhaBowl = new Lunch("Buddha Bowl",
				...
				"13", lunch, "/images/Lunch/buddha-bowl.jpeg", "/images/Lunch/buddha-bowl-2.jpg", "/images/Lunch/buddha-bowl-3.jpg");
		Lunch squareMeal = new Lunch("Square Meal",
				...
				"10", lunch, "/images/Lunch/square-meal.jpg", "/images/Lunch/square-meal-2.jpg", "/images/Lunch/square-meal-3.jpg");
		Lunch northstarBurger = new Lunch("Northstar Burger",
				...
				"14", lunch, "/images/Lunch/northstar-burger.jpeg", "/images/Lunch/northstar-burger-2.jpg", "/images/Lunch/northstar-burger-3.jpg");
		Lunch classicCheeseburger = new Lunch("Classic Cheeseburger",
				...
				"15", lunch, "/images/Lunch/classic-cheeseburger.jpeg", "/images/Lunch/classic-cheeseburger-2.jpg", "/images/Lunch/classic-cheeseburger-3.jpg");
		Lunch fishSandwich = new Lunch("Fish Sandwich",
				...
				"/images/Lunch/fish-sandwich.jpg", "/images/Lunch/fish-sandwich-2.jpg", "/images/Lunch/fish-sandwich-3.jpg");
		Lunch chickenAndAvoSandwich = new Lunch("Chicken & Avocado Sandwich",
				...
				"15", lunch, "/images/Lunch/chicken-and-avocado-sandwich.jpg", "/images/Lunch/chicken-and-avocado-sandwich-2.jpg", "/images/Lunch/chicken-and-avocado-sandwich-3.jpg");
		Lunch thaiburrito = new Lunch("Thai Burrito",
				...
				"12.5", lunch, "/images/Lunch/thai-burrito.jpg", "/images/Lunch/thai-burrito-2.jpg", "/images/Lunch/thai-burrito-3.jpg");
		Lunch sweetBasilBurrito = new Lunch("Sweet Basil Burrito",
				...
				"13", lunch, "/images/Lunch/sweet-basil-burrito.jpg", "/images/Lunch/sweet-basil-burrito-2.jpg", "/images/Lunch/sweet-basil-burrito-3.jpg");
		Lunch spicyHarvest = new Lunch("Spicy Harvest",
				...
				lunch, "/images/Lunch/spicy-harvest-pizza.jpg", "/images/Lunch/spicy-harvest-pizza-2.jpg", "/images/Lunch/spicy-harvest-pizza-3.jpg");
		Lunch housemadeSausage = new Lunch("Housemade Sausage",
				...
				"14", lunch, "/images/Lunch/housemade-sausage-pizza.jpg", "/images/Lunch/housemade-sausage-pizza-2.jpg", "/images/Lunch/housemade-sausage-pizza-3.jpg");
		Lunch smokedGoudaAndChicken = new Lunch("Smoked Gouda + Chicken",
				...
				lunch, "/images/Lunch/smoked-gouda-and-chicken-pizza.jpeg", "/images/Lunch/smoked-gouda-and-chicken-pizza-2.jpg", "/images/Lunch/smoked-gouda-and-chicken-pizza-3.jpg");
		Lunch highStreetVegetable = new Lunch("High Street Vegetable",
				...
				"12", lunch, "/images/Lunch/high-street-vegetable-pizza.jpeg", "/images/Lunch/high-street-vegetable-pizza-2.jpg", "/images/Lunch/high-street-vegetable-pizza-3.jpg");
